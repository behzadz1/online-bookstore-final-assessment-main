...
def test_two_clients_basic_isolation_smoke():
    ...
    with app.test_client() as a:
        ra = a.post('/add-to-cart', data={'title': '1984', 'quantity': '2'}, follow_redirects=True)
    ...
    with app.test_client() as b:
        rb = b.post('/add-to-cart', data={'title': 'The Great Gatsby', 'quantity': '3'}, follow_redirects=True)
...
def test_logout_smoke():
    ...
    with app.test_client() as c:
        c.post('/add-to-cart', data={'title': '1984', 'quantity': '1'}, follow_redirects=True)
